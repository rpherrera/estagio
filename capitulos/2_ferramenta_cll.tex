...
\footnotetext[1]{Servidor \textit{Web Apache} disponível na página do projeto \url{http://httpd.apache.org/}}
\footnotetext[2]{Servidor de banco de dados \textit{MySQL} disponível na página do projeto \url{http://mysql.com/}}
\footnotetext[3]{Interpretador de scripts \textit{PHP} disponível na página do projeto \url{http://php.net/}}
